...
!/
      ...
      use ww3_cpl_indices  , only : index_w2x_Sw_peakcp, index_w2x_Sw_hs     ! XS 220716
...
!--- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    SUBROUTINE WAV_INIT_MCT( EClock, cdata, x2w_w, w2x_w, NLFilename )
      ...
      ! XS 220716: add initialization for peakcp and hs
      do jsea=1, nseal
          ...
          w2x_w%rattr(index_w2x_Sw_peakcp,jsea)  = 0.
          w2x_w%rattr(index_w2x_Sw_hs,jsea)      = 0.     
      enddo
    ...
    SUBROUTINE WAV_RUN_MCT(EClock, cdata_w, x2w_w, w2x_w)
      ...
      do jsea=1, nseal
         ...
         if (MAPSTA(IY,IX) .eq. 1) then
             ...
             w2x_w%rattr(index_w2x_Sw_peakcp,jsea)  = PEAKCP(ISEA)  ! XS 220716
             w2x_w%rattr(index_w2x_Sw_hs,jsea)      = HS(ISEA)  ! XS 220716
          else
             w2x_w%rattr(index_w2x_Sw_lamult,jsea) = 1.
             w2x_w%rattr(index_w2x_Sw_ustokes,jsea) = 0.
             w2x_w%rattr(index_w2x_Sw_vstokes,jsea) = 0.
             w2x_w%rattr(index_w2x_Sw_hstokes,jsea) = 0.
             w2x_w%rattr(index_w2x_Sw_peakcp,jsea)  = 0.   ! XS 220716
             w2x_w%rattr(index_w2x_Sw_hs,jsea)      = 0.   ! XS 220716
          endif
      enddo
